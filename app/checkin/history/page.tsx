...
// 2026-05-26 CPO/Designer/CTO 검토 진행:
            ...
            <div key={d.date} className="flex flex-col items-center gap-1">
              <div
                className={`w-full aspect-square rounded-lg flex items-center justify-center text-lg ${
                  d.done
                    ? 'bg-primary bg-opacity-10 border border-primary/30'
  ...
  return (
    <div className="space-y-3">
      {eveningCheckins.map((c) => (
        <div key={c.id} className="bg-white rounded-xl border border-background-tertiary p-4">
