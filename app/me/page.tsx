      ...
      <div className="mx-auto max-w-lg px-5 pb-28 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-card border border-background-tertiary bg-white p-4 text-center">
          ...
          {/* 등급 카드 */}
          <div className="mt-3 rounded-card border border-warning/30 bg-white p-4">
        ...
        <div>
          ...
          <div className="divide-y divide-background-tertiary overflow-hidden rounded-card border border-background-tertiary bg-white">
        ...
        <div>
          ...
          <div className="rounded-card border border-background-tertiary bg-white px-4">
            <PushToggle />
          </div>
        </div>
