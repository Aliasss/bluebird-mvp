  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10 space-y-8">
        <section className="bg-white border border-warning rounded-2xl p-6 sm:p-8 space-y-4 text-center">
        ...
        <section className="bg-white border border-background-tertiary rounded-2xl p-5 space-y-3">
          ...
          <ol className="text-sm text-text-secondary space-y-2 list-decimal pl-5">
            ...
            <li>
              ...
              <span className="text-text-tertiary"> (재가입 불요)</span>
            </li>
          </ol>
        </section>
        ...
        <section className="text-xs text-text-tertiary pt-4 border-t border-background-tertiary space-y-2">
          <p>
            ※ 본 계정·답변 데이터는 PIPA 정합으로 처리됩니다. 자세한 사항은{' '}
