...
export default function StageTransitionModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl p-6 shadow-card max-w-sm w-full"
      ...
      >
        ...
        <div className="mt-5 flex items-center justify-end gap-2">
          ...
          <button
            type="button"
            onClick={handleDismiss}
            className="text-xs font-semibold text-white bg-primary hover:bg-primary/90 transition-colors px-4 py-1.5 rounded-lg"
          >
            확인
          </button>
        </div>
