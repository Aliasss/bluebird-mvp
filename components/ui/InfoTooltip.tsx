  ...
  return (
    <span className="inline-flex items-center gap-1 relative">
      ...
      {open && (
        <span
          role="tooltip"
          className="absolute top-full left-0 mt-1 px-2 py-1.5 text-[11px] text-white bg-text-primary rounded-md shadow-card max-w-[280px] whitespace-normal leading-snug z-20"
        >
          {text}
        </span>
      )}
