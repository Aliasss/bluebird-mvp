...
export const SLIDES: SlideMeta[] = [
  // ━━━ Act 1 — 왜 디버깅이 필요한가 ━━━
  {
    ...
    paragraphs: [
      ...
      '같은 자극에 같은 방식으로 반응합니다.',
      '직장·체면·자기낙인이 그 회로를 강화합니다.',
    ],
  },
  {
    id: 'act1-2',
    ...
    paragraphs: [
      '왜 같은 실수가 반복될까요?',
      '사고는 학습됩니다. 그리고 학습된 사고는 자동으로 작동합니다.',
      '이것이 인지 왜곡입니다.',
    ],
  },
  {
    ...
    paragraphs: [
      '명상은 가라앉히지만 분석하지 않습니다.',
      '코칭은 비싸고 느립니다. 일기는 누적되지만 디버깅하지 않습니다.',
      '챗봇은 위로하지만 구조를 보여주지 않습니다.',
      '사고를 구조로 보여주는 도구는 비어 있습니다.',
    ],
  },
  // ━━━ Act 2 — 어떤 이론으로 디버깅하는가 ━━━
  {
    ...
    paragraphs: [
      '사고는 두 시스템으로 작동합니다.',
      'System 1은 10ms 안에 자동 반응합니다. System 2는 3초 들여 검증합니다.',
      '디버깅은 System 1을 System 2로 옮기는 일입니다.',
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '당신의 사고가 어느 패턴에 빠지는지, BlueBird가 표시합니다.',
    ],
  ...
  },
  {
    ...
    paragraphs: [
      '우리는 손실에 2.25배 민감합니다.',
      '반추와 걱정은 측정 가능한 신호입니다.',
      'BlueBird는 이 신호들을 디버깅 입력으로 받습니다.',
    ],
  ...
  // ━━━ Act 3 — 어떻게 작동하고 무엇이 남는가 ━━━
  {
    ...
    paragraphs: [
      '기록: 자극과 자동 반응을 잡습니다.',
      '분석: CBT 5왜곡 + Dual Process로 분해합니다.',
      '검증: 반증 질문으로 System 2를 깨웁니다.',
      '재평가: 같은 자극에 다른 판단을 내립니다.',
    ],
  },
  {
    id: 'act3-2',
  ...
  },
  {
    ...
    paragraphs: [
      '사용할수록 당신의 사용설명서가 채워집니다.',
      '7회 후 첫 패턴이 보이고, 30회 후 자기 지도가 정교해집니다.',
      '목표는 치료가 아닙니다. 자기 운영입니다.',
    ],
