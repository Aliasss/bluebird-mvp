...
-- 알림 인프라 측정 이벤트 — IM.1 §1.2 KPI 산출 (권한 동의율·전환율·거부율).
--
-- Spec: docs/strategy/push-infra-review-2026-05-09.md §5.2 U1
-- Plan: docs/superpowers/plans/2026-05-09-push-infra.md (Phase I)
--
-- 정책:
...
-- ============================================================
-- KPI 집계 view — IM.1 D7·D14 측정 단순화.
-- ============================================================
